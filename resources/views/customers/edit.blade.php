            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">{{ __('customer.edit_title') }}</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @method('put')
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="shopname">{{ __('customer.shopname') }} <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('shopname') is-invalid @enderror"
                                       id="shopname" name="shopname" value="{{ old('shopname', $customer->shopname) }}" required>
                                @error('shopname') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            <div class="form-group col-md-6">
                                <label for="email">{{ __('customer.email') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="phone">{{ __('customer.phone') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="account_holder">{{ __('customer.account_holder') }}</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="bank_name">{{ __('customer.bank_name') }}</label>
                                <select class="form-control @error('bank_name') is-invalid @enderror" name="bank_name">
                                    <option value="">{{ __('customer.select') }}</option>
                                    <option value="BRI" @selected(old('bank_name', $customer->bank_name) == 'BRI')>BRI</option>
                                    <option value="BNI" @selected(old('bank_name', $customer->bank_name) == 'BNI')>BNI</option>
                                    <option value="BCA" @selected(old('bank_name', $customer->bank_name) == 'BCA')>BCA</option>
                                    <option value="BSI" @selected(old('bank_name', $customer->bank_name) == 'BSI')>BSI</option>
                                    <option value="Mandiri" @selected(old('bank_name', $customer->bank_name) == 'Mandiri')>Mandiri</option>
                                </select>
                                @error('bank_name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            <div class="form-group col-md-6">
                                <label for="account_number">{{ __('customer.account_number') }}</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="bank_branch">{{ __('customer.bank_branch') }}</label>
                                <input type="text" class="form-control @error('bank_branch') is-invalid @enderror"
                                       id="bank_branch" name="bank_branch" value="{{ old('bank_branch', $customer->bank_branch) }}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror"
                                          name="address" required>{{ old('address', $customer->address) }}</textarea>
                        ...
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary mr-2">{{ __('customer.update') }}</button>
                            <a class="btn bg-danger" href="{{ route('customers.index') }}">{{ __('customer.cancel') }}</a>
                        </div>
