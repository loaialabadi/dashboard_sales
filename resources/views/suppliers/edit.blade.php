            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">{{ __('supplier_form.edit_title') }}</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @method('put')
                        ...
                        <div class="row">
                            <div class="input-group mb-4 col-lg-6">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="photo">{{ __('supplier_form.choose_file') }}</label>
                                </div>
                                @error('photo')
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control @error('bank_name') is-invalid @enderror" name="bank_name">
                                    <option value="">{{ __('supplier_form.select_bank') }}</option>
                                    <option value="BRI" @if(old('bank_name', $supplier->bank_name) == 'BRI') selected @endif>BRI</option>
                                    <option value="BNI" @if(old('bank_name', $supplier->bank_name) == 'BNI') selected @endif>BNI</option>
                                    <option value="BCA" @if(old('bank_name', $supplier->bank_name) == 'BCA') selected @endif>BCA</option>
                                    <option value="BSI" @if(old('bank_name', $supplier->bank_name) == 'BSI') selected @endif>BSI</option>
                                    <option value="Mandiri" @if(old('bank_name', $supplier->bank_name) == 'Mandiri') selected @endif>Mandiri</option>
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control @error('type') is-invalid @enderror" name="type" required>
                                    <option value="">{{ __('supplier_form.select_type') }}</option>
                                    <option value="Distributor" @if(old('type', $supplier->type) == 'Distributor') selected @endif>Distributor</option>
                                    <option value="Whole Seller" @if(old('type', $supplier->type) == 'Whole Seller') selected @endif>Whole Seller</option>
                                </select>
                        ...
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary mr-2">{{ __('supplier_form.update') }}</button>
